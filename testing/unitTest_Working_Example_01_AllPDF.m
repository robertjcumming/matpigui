...
%  Copyright: Matpi Ltd.
%  $Id: unitTest_Working_Example_01_AllPDF.m 215 2015-07-27 19:00:38Z Bob $
classdef unitTest_Working_Example_01_AllPDF < matpiguiTest   
  properties
  ...
  methods (TestClassSetup)
    function obj = RunsBeforeAllTests(obj)
      ...
      % normally only failed tests are logged to the pdf - for this example
      % we will log all data
      obj.logFailedOnly = false;
      % update the filename of the pdf
      obj.g2pdf.pdfFilename = 'unitTest_Working_Example_01_AllPDF.pdf';
